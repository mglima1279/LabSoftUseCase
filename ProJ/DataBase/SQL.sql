...
CREATE TABLE [dbo].[CentralDeCusto](
	...
	[ValorMetaAnual] [decimal](18, 0) NULL,
...
GO
 Object  Table [dbo].[Departamento]    Script Date 04092026 163851 
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
 Object  Table [dbo].[Funcionario]    Script Date 04092026 163851 
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
 Object  Table [dbo].[Incidente]    Script Date 04092026 163851 
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
 Object  Table [dbo].[Tarefa]    Script Date 04092026 163851 
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[CentralDeCusto] ADD  DEFAULT ((0)) FOR [ValorMetaAnual]
GO
ALTER TABLE [dbo].[Funcionario]  WITH CHECK ADD FOREIGN KEY([DepartamentoId])
REFERENCES [dbo].[Departamento] ([Codigo])
GO
ALTER TABLE [dbo].[Funcionario]  WITH CHECK ADD FOREIGN KEY([IdGerente])
REFERENCES [dbo].[Funcionario] ([Codigo])
GO
ALTER TABLE [dbo].[Tarefa]  WITH CHECK ADD  CONSTRAINT [FK_Tarefa_Funcionario] FOREIGN KEY([FuncionarioId])
REFERENCES [dbo].[Funcionario] ([Codigo])
GO
ALTER TABLE [dbo].[Tarefa] CHECK CONSTRAINT [FK_Tarefa_Funcionario]
GO
